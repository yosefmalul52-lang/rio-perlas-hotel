    ...
    <FadeUp>
      ...
      >
        ...
        {form.stayType === "custom" ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <label className="block space-y-1.5">
              <span className="font-label-caps text-[10px] uppercase tracking-wider text-pura-text-muted">{chooseStay.checkIn}</span>
              <input
                required
                type="date"
                value={form.checkIn}
            ...
            <label className="block space-y-1.5">
              <span className="font-label-caps text-[10px] uppercase tracking-wider text-pura-text-muted">{chooseStay.checkOut}</span>
              <input
                required
                type="date"
                value={form.checkOut}
